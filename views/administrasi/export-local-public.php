    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'attribute' => 'variety_ids',
                'label'     => 'Variety Participant',
                'value'     => 'variety.variety',
                /*'filter' => Html::activeDropDownList(Arrayhelper::map(Varietypartisipant::find()->where(['group_participant_id'   => 2])->asArray()->all(), 'id', 'variety'),['class'  => 'form-control','prompt'  => '-- Select Variety Participant --']),*/
            ],
