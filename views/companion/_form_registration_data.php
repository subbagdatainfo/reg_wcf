        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="jumbotron">
                <div style="padding:5px;">
                    ...
                    <!-- Button Option -->
                    <h4 style="font-weight:500px; font-size:24px; margin:0;">Personal Details </h4>
                    <!-- Button Option -->
...
var pilihan = document.getElementById('companionregistration-nationality').value;
...
var transportation = document.getElementById('companionregistration-transportation').value;
...
{
    var data_pilihan = document.getElementById('companionregistration-nationality').value;
...
function ConditionalForCulturalVisit()
{
    ...
    var dateArrival = document.getElementById('companionregistration-date_arrival').value;
    var TimeArrival = document.getElementById('companionregistration-time_arrival').value;
...
function Date_arrival_changed(e){
    document.getElementById('date_arrival').innerHTML = document.getElementById('companionregistration-date_arrival').value;
}

function Date_departure_changed(e){
    var value_date_departure = document.getElementById('companionregistration-date_departure').value;
