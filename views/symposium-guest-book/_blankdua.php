...
<div class="registrasi-view">
    ...
    <?php if(!empty($model_participant->symposium_day_two_id)){ ?>
        <div class="jumbotron" style="margin-top:10px;">
            ...
            <p>Anda terdaftar di symposium 
                <br>
                <br>
                <b><?= $model_participant->symposiumdaytwo->symposium_name; ?></b> - <b>Symposium <?= $model_participant->symposium_day_two_id; ?></b></p>        
        </div>
