...
$this->title = 'Registrasi Symposium : '. $symposium_lima->symposium_name;

$this->params['breadcrumbs'][] = $this->title;
?>
<div class="registrasi-index">

    <center><h1><b><?= Html::encode($this->title) ?></b></h1></center>
        ...
        <div class="col-md-6 col-md-offset-3">
            <form action="<?= Url::to(['/symposium-guest-book/register-hari-kedua']); ?>" method="GET">
                  <div class="form-group">
                        <input type="hidden" class="form-control" name="id" value="5">
