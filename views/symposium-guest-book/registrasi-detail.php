...
<div class="registrasi-view">
    ...
    <div class="jumbotron" style="margin-top:10px;">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <pre style="margin:0; padding:5px; background:white;"><div class="text-center"><?= $symposium_guest->symposium_name; ?></div></pre>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 pull-right">
                    ...
                    <a href="<?= Url::to(['list-symposium', 'id'   => $_GET['id']]); ?>" class="btn btn-primary btn-block">View Participant</a>
            </div>
