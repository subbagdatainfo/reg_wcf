...
?>
    ...
    <?php
        ...
        echo Nav::widget([
            ...
            'items' => [
                ...
                // $role_user == 'register' ? ['label' => 'Confirmation', 'url' => ['participant/confirmation']] : (''),
    ...
    <?php if ( Url::current() == '/web/user/admin/index') { ?>
...
<footer class="footer" style="position:fixed; bottom:0;">
    <div class="col-md-5">
         <p class="pull-left">
                    <a href="https://www.facebook.com/WorldCultureForum/"><i class="gdlr-icon fa fa-facebook-square fa-footer" style="color: #3b5998; font-size: 25px; " ></i></a> 
