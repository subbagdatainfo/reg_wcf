    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [  
                ...
                'header'=>'Actions',
                // 'template' => '{view} {update} {updateall} {delete}',
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>', $url, [
                            'title' => Yii::t('app', 'Update Invitation Data'),
                        ]);
                    },
                    'updateall' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-file" aria-hidden="true"></span>', $url, [
                            'title' => Yii::t('app', 'Update All Data'),
                        ]);
                    },
                    'delete' => function ($url, $model) {
                        ...
                        return Html::a('<span class="btn btn-primary btn-xs" aria-hidden="true"> Update Invitation</span>', $url, [
                            'title' => Yii::t('app', 'Update Invited International Invitation'), 
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url ='invitedview?id='.$model->id;
                        return $url;
                    }elseif ($action === 'update') {
                        $url ='invitedupdate?id='.$model->id;
                        return $url;
                    }elseif ($action === 'updateall') {
                        $url ='invitedupdateall?id='.$model->id;
                        return $url;
                    }elseif ($action === 'delete') {
                        $url ='inviteddelete?id='.$model->id;
                        return $url;
                    }elseif ($action === 'update-invitation') {
                        $url ='internationalupdateinvitation?id='.$model->id;
                        return $url;
                    }
                }
