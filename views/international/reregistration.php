        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="jumbotron">
                <div style="padding:5px;">
                    ...
                    <div class="row">
                            <?php if(empty($model->submit)){ 
                                    $model->submit = 0;
                            } ?>
                            <div class="col-md-6 col-sm-6">
                                <?= $form->field($model, 'submit')->widget(Select2::classname(), [
                                    'data' => [1 => 'TRUE', 0 => 'FALSE'],
                                    'options' => [
                                        'placeholder' => 'Status Submit',
                                        'data-toggle' => 'tooltip',
                            ...
                            <div class="col-sm-12" style="margin-bottom:10px;">
                                    ...
                                    <?php
                                        ...
                                        foreach ($list_symposium_day_one as $key => $value) {
                                            $olah_symposium_day_one[$key] = $value . " (" .Participant::find()->where(['symposium_day_one_id'=> $key])->count() . " / 210)";
                            ...
                            <div class="col-sm-12">
                                    ...
                                    <?php
                                        ...
                                        foreach ($list_symposium_day_two as $key => $value) {
                                            $olah_symposium_day_two[$key] = $value . " (" .Participant::find()->where(['symposium_day_two_id'=> $key])->count() . " / 210)";
