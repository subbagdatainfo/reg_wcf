...
class LocalController extends \yii\web\Controller
{
    ...
    public function actionPrintBadgeLocal()
    {
        $this->layout = 'dashboard';
     ...
     public function actionPrintBadgeLocalInvited()
    {
        $this->layout = 'dashboard';
        /*if (isset($_POST['hasEditable'])) {
    ...
    public function actionLocalupdateinvitation($id)
    {
        $this->layout = 'dashboard';
                ...
                if (Yii::$app->request->post()) {
                    ...
                    // ========================================= UPLOAD ===========================================================================
                        ...
                        if ($model->save()) {
                            ...
                            return $this->redirect(['local/invited']);
    ...
    {
        $this->layout = 'dashboard';
        $this->findModelLocalInvited($id)->delete();
                ...
                if (Yii::$app->request->post()) {
                    ...
                    // ========================================= UPLOAD ===========================================================================
                        ...
                        if ($model->save()) {
                            ...
                            return $this->redirect(['local/public']);
    ...
    protected function findModelLocalInvited($id)
    {
        if (($model = Participant::findOne($id)) !== null) {
            return $model;
        } else {
