...
use kartik\mpdf\Pdf;
class WdbController extends \yii\web\Controller
{




    //  ====================== PRINT BADGE UNTUK WDB =============================


    public function actionSpeakerBadge()
    {
        ...
        return $this->render('speaker-badge', [
    ...
    public function actionSymposiumBadge()
    {
        $this->layout = 'dashboard';
...
*/
        ...
        return $this->render('symposium-badge', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }

    public function actionIyfBadge()
    {
        $this->layout = 'dashboard';
        ...
        return $this->render('iyf-badge', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }

    //  ====================== END PRINT BADGE UNTUK WDB ============================= 
    ...
    public function actionSpeakerview($id)
    {
        $this->layout = 'dashboard';
        return $this->render('speakerview', [
            'model' => $this->findModel($id),
        ]);
    }

    public function actionSpeakerupdateinvitation($id)
    {
        $this->layout = 'dashboard';
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['speakerview', 'id' => $model->id]);
        } else {
    ...
    public function actionSpeakerupdate($id)
    {
        $this->layout = 'dashboard';
                ...
                if (Yii::$app->request->post()) {
                    ...
                    // ========================================= UPLOAD ===========================================================================
                        ...
                        if ($model->save()) {
                            ...
                            return $this->redirect(['wdb/speaker']);
    ...
    {
        $this->layout = 'dashboard';
        $this->findModelWdb($id)->delete();

        return $this->redirect(['speaker']);
    }

    //================================================ END CONTROLLER SPEAKER ====================================
    ...
    public function actionSymposium()
    {
        ...
        return $this->render('symposium', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
    public function actionSymposiumview($id)
    {
        $this->layout = 'dashboard';
        return $this->render('symposiumview', [
            'model' => $this->findModel($id),
        ]);
    }

    public function actionSymposiumupdateinvitation($id)
    {
        $this->layout = 'dashboard';
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['symposiumview', 'id' => $model->id]);
        } else {
            return $this->render('update-invitation', [
                'model' => $model,
            ]);
    ...
    public function actionSymposiumupdate($id)
    {
        $this->layout = 'dashboard';
                ...
                if (Yii::$app->request->post()) {
                    ...
                    // ========================================= UPLOAD ===========================================================================
                        ...
                        if ($model->save()) {
                            ...
                            return $this->redirect(['wdb/symposium']);
     ...
     public function actionSymposiumdelete($id)
    {
        $this->layout = 'dashboard';
        $this->findModelWdb($id)->delete();

        return $this->redirect(['symposium']);
    }




    //================================================ END CONTROLLER SYMPOSIUM ====================================
    ...
    public function actionIyf()
    {
    	$this->layout = 'dashboard';
        $searchModel = new ParticipantSearch();
        $dataProvider = $searchModel->searchIyf(Yii::$app->request->queryParams);

        return $this->render('iyf', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
    public function actionIyfview($id)
    {
        $this->layout = 'dashboard';
        return $this->render('iyfview', [
            'model' => $this->findModel($id),
        ]);
    }

     public function actionIyfupdateinvitation($id)
    {
        $this->layout = 'dashboard';
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['iyfview', 'id' => $model->id]);
        } else {
            return $this->render('update-invitation', [
                'model' => $model,
            ]);
    ...
    public function actionIyfupdate($id)
    {
        $this->layout = 'dashboard';
    ...
    public function actionIyfdelete($id)
    {
        $this->layout = 'dashboard';
        $this->findModelWdb($id)->delete();

        return $this->redirect(['iyf']);
    }
    ...
    protected function findModel($id)
    {
     ...
     protected function findModelWdb($id)
    {
        if (($model = Participant::findOne($id)) !== null) {
            return $model;
        } else {
