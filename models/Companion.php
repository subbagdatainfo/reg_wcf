...
class Companion extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'full_name', 'name_on_badge', 'address', 'gender', 'date_of_birth', 'nationality', 'place_of_issue', 'email', 'category', 'organization', 'abstract', 'file_presentation', 'full_paper','tell_us','candidate_chosen','flight_number_arrival','flight_number_departure','pasport_ktp_number'], 'string'],
