 ...
 */
class Participantselection extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['token', 'country_id', 'phone','handphone', 'fax', 'participant_status', 'variety_id', 'dietary_id', 'symposium_day_one_id', 'symposium_day_two_id', 'attend_id','room_type_id','is_companion_from'], 'integer'],
            [['title', 'full_name', 'name_on_badge', 'address', 'gender', 'date_of_birth', 'place_of_issue', 'email', 'category', 'organization', 'abstract', 'file_presentation', 'full_paper','tell_us','candidate_chosen','flight_number_arrival','flight_number_departure','pasport_ktp_number','hotel_id'], 'string'],
            [['full_name', 'variety_id','title'], 'required'],
