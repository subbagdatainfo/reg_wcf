 ...
 */
class Participantbadge extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['token', 'country_id', 'phone','handphone', 'fax', 'participant_status', 'variety_id', 'dietary_id', 'symposium_day_one_id', 'symposium_day_two_id', 'attend_id','room_type_id','is_companion_from','hotel_id'], 'integer'],
