 ...
 */
class Companionregistration extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'full_name', 'name_on_badge', 'address', 'gender', 'date_of_birth', 'nationality', 'place_of_issue', 'email', 'category', 'organization', 'abstract','tell_us','candidate_chosen','tittle','author','content','pasport_ktp_number','dietary_specify'], 'string'],
            ...
            [['partisipant', 'speaker', 'visit_subak_bali', 'cultural_visit', 'is_delete','room_type_approve','is_representative','is_companion','is_companion_valid'], 'boolean'],
