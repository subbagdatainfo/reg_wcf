 ...
 */
class Participantregistration extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'full_name', 'name_on_badge', 'address', 'gender', 'date_of_birth', 'nationality', 'place_of_issue', 'email', 'category', 'organization', 'abstract','tell_us','candidate_chosen','tittle','author','content','pasport_ktp_number','dietary_specify','flight_number_arrival','flight_number_departure'], 'string'],
            [['full_name', 'variety_id','title','name_on_badge','address','gender','date_of_birth','nationality','pasport_ktp_number','country_id','place_of_issue','phone','handphone','email','organization','cultural_visit','symposium_day_one_id','symposium_day_one_id','symposium_day_one_id','symposium_day_two_id','room_type_approve'], 'required'],
            [['start_date'],'string','message' => 'Date Of Issue cannot be blank'],
            [['end_date'],'string','message' => 'Expired date cannot be blank'],
            [['user_photo'],'required','on'=>'tidak_ada_user_photo'],
            [['ktp_pasport'],'required','on'=>'tidak_ada_ktp_pasport'],
            [['user_photo','ktp_pasport'],'required','on'=>'tidak_ada_user_photo_dan_ktp_pasport'],
            [['start_date', 'end_date', 'date_arrival', 'time_arrival', 'date_departure', 'time_departure', 'start_date_attend', 'end_date_attend'], 'safe'],
            [['partisipant', 'speaker', 'visit_subak_bali', 'cultural_visit', 'is_delete','submit'], 'boolean'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'dietary_specify'   => 'dietary_specify',
