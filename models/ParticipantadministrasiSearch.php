 ...
 */
class ParticipantadministrasiSearch extends Participantadministrasi
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['partisipant', 'speaker', 'visit_subak_bali', 'cultural_visit', 'is_delete','status_subsidi'], 'boolean'],
        ];
    }
    ...
    {
        $query = Participant::find()->orderBy(['full_name' => SORT_ASC]);
